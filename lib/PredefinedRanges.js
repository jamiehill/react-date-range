  ...
  _createClass(PredefinedRanges, [{
    ...
    value: function handleSelect(name, event) {
      ...
      this.props.onSelect({
        ...
        endDate: (0, _utilsParseInputJs2['default'])(range['endDate'], 'endOf')
      }, PredefinedRanges);
    }
  }, {
    key: 'renderRangeList',
    value: function renderRangeList(classes) {
      ...
      return Object.keys(ranges).map((function (name) {
        var active = (0, _utilsParseInputJs2['default'])(ranges[name].startDate, null, 'startOf').isSame((0, _utilsParseInputJs2['default'])(range.startDate, null, 'startOf')) && (0, _utilsParseInputJs2['default'])(ranges[name].endDate, null, 'endOf').isSame((0, _utilsParseInputJs2['default'])(range.endDate, null, 'endOf'));
